...
dpi = 300
fig_size = [12, 10]
plotting_folder = '/Volumes/ELEMENTS/Storage/Personal/Git/vivino-majestic/analysis/plots/wine_red'

# Import data
folder = '/Volumes/ELEMENTS/Storage/Personal/Git/vivino-majestic/analysis'
cols = ['Product Name', 'Rating', 'Price', 'Region']
data_italy = pandas.read_csv('{}/data/wine_red/italy.csv'.format(folder), names=cols, sep='\t', skiprows=2).fillna(np.NaN)
data_spanish = pandas.read_csv('{}/data/wine_red/spanish.csv'.format(folder), names=cols, sep='\t', skiprows=2).fillna(np.NaN)
data_french = pandas.read_csv('{}/data/wine_red/french.csv'.format(folder), names=cols, sep='\t', skiprows=2).fillna(np.NaN)
data_new_zealand = pandas.read_csv('{}/data/wine_red/new-zealand.csv'.format(folder), names=cols, sep='\t', skiprows=2).fillna(np.NaN)
data_american = pandas.read_csv('{}/data/wine_red/american.csv'.format(folder), names=cols, sep='\t', skiprows=2).fillna(np.NaN)
data_australian = pandas.read_csv('{}/data/wine_red/australian.csv'.format(folder), names=cols, sep='\t', skiprows=2).fillna(np.NaN)
data_south_african = pandas.read_csv('{}/data/wine_red/south-african.csv'.format(folder), names=cols, sep='\t', skiprows=2).fillna(np.NaN)
data_portuguese = pandas.read_csv('{}/data/wine_red/portuguese.csv'.format(folder), names=cols, sep='\t', skiprows=2).fillna(np.NaN)
data_argentinian = pandas.read_csv('{}/data/wine_red/argentinian.csv'.format(folder), names=cols, sep='\t', skiprows=2).fillna(np.NaN)
data_chilean = pandas.read_csv('{}/data/wine_red/chilean.csv'.format(folder), sep='\t', names=cols, skiprows=2).fillna(np.NaN)

# Clean data
country = ['Italy', 'Spain', 'French', 'New Zealand', 'USA', 'Australia', 'South Africa', 'Portugal', 'Argentina', 'Chile']
data_all = [data_italy, data_spanish, data_french, data_new_zealand, data_american, data_australian, data_south_african,
...
for i in range(len(data_all)):
    ...
    print('Average Price', data_all[i].loc[:, 'Price'].mean())
    print('Average rating',  data_all[i].loc[:, 'Rating'].mean())
    counter_country = 0
...
wines_selected.to_csv('{}/data/wine_red/wines_rating-above-{}_price-below-{}.csv'.format(folder, rating_above, price_below),
                      index=False, sep='|')
...
fig_plot_all_1.savefig('{}/price_rating_all.png'.format(plotting_folder), dpi=dpi)
...
fig_plot_all_2.savefig('{}/price_rating_all_zoom.png'.format(plotting_folder), dpi=dpi)
...
fig_plot_italy.savefig('{}/price_rating_italy.png'.format(plotting_folder), dpi=dpi)
# fig_plot_italy.savefig('{}/price_rating_italy-multiple-regions-only.png'.format(plotting_folder), dpi=dpi)
...
fig_plot_spain.savefig('{}/price_rating_spain.png'.format(plotting_folder), dpi=dpi)
# fig_plot_spain.savefig('{}/price_rating_spain-multiple-regions-only.png'.format(plotting_folder), dpi=dpi)
...
# fig_plot_france.savefig('{}/price_rating_france_minimal.png'.format(plotting_folder), dpi=dpi)
fig_plot_france.savefig('{}/price_rating_france.png'.format(plotting_folder), dpi=dpi)
# fig_plot_france.savefig('{}/price_rating_france-multiple-regions-only.png'.format(plotting_folder), dpi=dpi)
...
fig_plot_new_zealand.savefig('{}/price_rating_new_zealand.png'.format(plotting_folder), dpi=dpi)
# fig_plot_new_zealand.savefig('{}/price_rating_new_zealand-multiple-regions-only.png'.format(plotting_folder), dpi=dpi)
...
fig_plot_american.savefig('{}/price_rating_american.png'.format(plotting_folder), dpi=dpi)
# fig_plot_american.savefig('{}/price_rating_american-multiple-regions-only.png'.format(plotting_folder), dpi=dpi)
...
fig_plot_australian.savefig('{}/price_rating_australian.png'.format(plotting_folder), dpi=dpi)
# fig_plot_australian.savefig('{}/price_rating_australian-multiple-regions-only.png'.format(plotting_folder), dpi=dpi)

# Plot all wine regions for South Africa
plot_country = 6
data_country_regions = data_all[plot_country].sort_values('Region').reset_index(drop=True)
fig_plot_south_african, ax_plot_south_african = plt.subplots(figsize=(fig_size[0], fig_size[1]))
fig_plot_south_african, ax_plot_south_african = \
    func_plot_country_region(fig_plot_south_african, ax_plot_south_african, data_country_regions, markers, cm, legend=True, plot_singles=False)
fig_plot_south_african.tight_layout()
# fig_plot_south_african.savefig('{}/price_rating_south_african.png'.format(plotting_folder), dpi=dpi)
fig_plot_south_african.savefig('{}/price_rating_south_african-multiple-regions-only.png'.format(plotting_folder), dpi=dpi)
...
fig_plot_portugeuse.savefig('{}/price_rating_portugeuse.png'.format(plotting_folder), dpi=dpi)
# fig_plot_portugeuse.savefig('{}/price_rating_portugeuse-multiple-regions-only.png'.format(plotting_folder), dpi=dpi)
...
fig_plot_argentinian.savefig('{}/price_rating_argentinian.png'.format(folder), dpi=dpi)
# fig_plot_argentinian.savefig('{}/price_rating_argentinian-multiple-regions-only.png'.format(folder), dpi=dpi)
...
fig_plot_chilean.savefig('{}price_rating_chilean.png'.format(plotting_folder), dpi=dpi)
# fig_plot_chilean.savefig('{}/price_rating_chilean-multiple-regions-only.png'.format(plotting_folder), dpi=dpi)
