...
def func_plot_country_region(func_fig, func_ax, func_data_1, func_markers, func_colors,
                             func_xlim=None, func_ylim=None, legend=False, legend_size=None):
...
cm = plt.get_cmap('hsv')
markers = list(Line2D.markers.keys())[2:30] * 5
    ...
    for j in range(data_all[i].shape[0]):
        if data_all[i].at[j, 'Price'] <= price_below and data_all[i].at[j, 'Rating'] >= rating_above:
            wines_selected.loc[counter_total] = (data_all[i].at[j, 'Product Name'], data_all[i].at[j, 'Rating'],
                                                 data_all[i].at[j, 'Price'], data_all[i].at[j, 'Region'], country[i])
...
fig_plot_all_2, ax_plot_all_2 = \
    func_plot_all(fig_plot_all_2, ax_plot_all_2, data_all, country, plotting_markers, plotting_colors, xlim_2, ylim_2, legend=True)
...
fig_plot_italy, ax_plot_italy = \
    func_plot_country_region(fig_plot_italy, ax_plot_italy, data_country_regions, markers, cm, legend=True)
...
fig_plot_spain, ax_plot_spain = \
    func_plot_country_region(fig_plot_spain, ax_plot_spain, data_country_regions, markers, cm, legend=True)
...
fig_plot_new_zealand, ax_plot_new_zealand = \
    func_plot_country_region(fig_plot_new_zealand, ax_plot_new_zealand, data_country_regions, markers, cm, legend=True)
...
fig_plot_american, ax_plot_american = \
    func_plot_country_region(fig_plot_american, ax_plot_american, data_country_regions, markers, cm, legend=True)
...
fig_plot_australian, ax_plot_australian = \
    func_plot_country_region(fig_plot_australian, ax_plot_australian, data_country_regions, markers, cm, legend=True)
...
fig_plot_portugeuse, ax_plot_portugeuse = \
    func_plot_country_region(fig_plot_portugeuse, ax_plot_portugeuse, data_country_regions, markers, cm, legend=True)
...
fig_plot_argentinian, ax_plot_argentinian = \
    func_plot_country_region(fig_plot_argentinian, ax_plot_argentinian, data_country_regions, markers, cm, legend=True)
...
fig_plot_chilean, ax_plot_chilean = \
    func_plot_country_region(fig_plot_chilean, ax_plot_chilean, data_country_regions, markers, cm, legend=True)
